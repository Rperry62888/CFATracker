...
namespace CFAStudentTracker.Controllers
{
    public class FileTypesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "FileTypeID,TypeDescription")] FileType fileType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "FileTypeID,TypeDescription")] FileType fileType)
        {
            if (ModelState.IsValid)
            {
